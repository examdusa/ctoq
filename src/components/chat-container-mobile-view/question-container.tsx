    ...
    >
      ...
      >
        <Flex
          ...
          gap={"sm"}
        >
          <Flex direction={"column"} h="auto" w={"100%"} gap={5}>
            <Flex direction={"row"} w={"100%"} align={"start"} gap={"sm"}>
...
function QuestionContainerMobilView({ subscription, questions }: Props) {
  ...
  return (
    <ScrollArea
      style={{ height: "calc(65vh - 8vh)", width: "100%" }}
      offsetScrollbars={"x"}
      my={"xs"}
      p={3}
...
export { QuestionContainerMobilView };
